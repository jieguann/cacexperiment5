...
const char* myID = "Unnikrishnan"; // place your name here, this will be put into your "sender" value for an outgoing messsage

char publishChannel[] = "Unnikrishnan"; // channel to publish YOUR data
char readChannel[] = "Jie"; // channel to read THEIR data
